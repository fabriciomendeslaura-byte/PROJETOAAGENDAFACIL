        ...
        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row gap-4 items-center bg-white rounded-t-xl">
          <div className="relative w-full sm:max-w-md">
            ...
            <Input 
              ...
              className="pl-9 bg-slate-50 border-transparent focus-visible:bg-white focus-visible:border-slate-300" 
            />
          </div>
          <Button variant="outline" className="w-full sm:w-auto ml-auto bg-white border-slate-200">
